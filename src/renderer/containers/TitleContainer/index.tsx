...
const Title: React.SFC = () => {
    const { listId, setListId, autoChange, setAutoChange } = useAppStore();
    const [modalVisible, setModalVisible] = useState<Boolean>(false);
    const modalContent = createRef<HTMLDivElement>();
